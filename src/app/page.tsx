   ...
   <Header />
    <div className="flex items-center justify-center">
      <div>
        ...
        <p className="text-center w-[660px] text-justify">Aqui, você pode se desapegar de itens usados que já não têm espaço na sua vida, dando a eles uma nova chance com alguém que os valorize. Além disso, você pode explorar e descobrir novos tesouros, peças únicas e raridades perdidas que aguardam por um novo dono – tudo em um só lugar.</p>
