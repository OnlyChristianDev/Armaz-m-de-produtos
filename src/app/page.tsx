...
const AddItem = () => {
  ...
  return (
   ...
   <Header />
    <div className="flex items-center justify-center max-sm:flex-col-reverse max-md:flex-col max-lg:flex-col">
      <div className="max-sm:p-8 max-md:p-8 max-lg:p-8 max-xl:p-8 xl:bg-red-600 flex items-start justify-center flex-col">
        <h1 className="text-6xl font-semibold">Bem vindo a <span className="text-blue-600">RETROVE.</span></h1>
        <p className="text-justify ">Aqui, você pode se desapegar de itens usados que já não têm espaço na sua vida, dando a eles uma nova chance com alguém que os valorize. Além disso, você pode explorar e descobrir novos tesouros, peças únicas e raridades perdidas que aguardam por um novo dono – tudo em um só lugar.</p>
      ...
      <div className="max-sm:w-56 max-md:w-72 max-lg:w-80">
